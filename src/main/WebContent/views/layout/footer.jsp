...
<footer class="footer">
	<div class="grid wide footer__content">
		<div class="row">
			<div class="col l-2-4 m-4 c-6">
				...
				<ul class="footer-list">
					...
					<li class="footer-item"><a href="#" class="footer-item__link">Hướng
							Dẫn Mua Hàng</a></li>
					<li class="footer-item"><a href="#" class="footer-item__link">Chính
			...
			<div class="col l-2-4 m-4 c-6">
				...
				<ul class="footer-list">
					<li class="footer-item"><a href="#" class="footer-item__link">mức</a>
					</li>
					<li class="footer-item"><a href="#" class="footer-item__link">Đầu
							buồi</a></li>
					<li class="footer-item"><a href="#" class="footer-item__link">ôn
							lằn</a></li>
				</ul>
			</div>
			<div class="col l-2-4 m-4 c-6">
	...
	<div class="footer__bottom">
		<div class="grid wide">
			<p class="footer__text">© 2022 sốp pi phake</p>
		</div>
	</div>
</footer>